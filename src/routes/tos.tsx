...
import { Shield, Truck, Copyright } from "lucide-react";
...
const sections = [
  {
    ...
    content: "All prices are in USD. A 50% non-refundable deposit is required to secure your slot and begin the sketch phase. The final 50% must be paid before the final high-resolution files are delivered to you. Clients receive up to three (3) revision rounds during the sketch and planning phase. Once the sketch is approved and final coloring/rendering begins, major changes cannot be made without an additional hourly fee.",
  },
  {
    icon: Truck,
        ...
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
          <AnimatedSection>
            <h1 className="text-4xl md:text-6xl font-heading font-black">
              Terms of Service & <span className="gradient-text text-glow">Client Agreement</span>
            </h1>
          </AnimatedSection>
        </div>
      </section>
