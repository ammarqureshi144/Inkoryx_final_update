...
const navItems = [
  ...
  { label: "Premium Incubator", to: "/booking" },
  { label: "Page to Pixel", to: "/process" },
  { label: "Verify", to: "/verify" },
  { label: "TOS", to: "/tos" },
];

const megaServices = [
  { icon: Palette, title: "Character & Lore", desc: "Custom illustrations & VTuber rigging" },
  { icon: Box, title: "Publishing & Branding", desc: "Book covers, logos, brand identity" },
  { icon: Gamepad2, title: "Games & Pixel Art", desc: "3D environments & game-ready assets" },
  { icon: Monitor, title: "UI & Digital Spaces", desc: "App interfaces & dashboards" },
  { icon: Sparkles, title: "Animation & Motion", desc: "Fluid animations & motion graphics" },
];
